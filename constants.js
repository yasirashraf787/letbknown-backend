module.exports = {
    ...
    CALLBACK_ERROR_REDIRECT_URL_AWS : 'https://d3rtuj6gjvv7z0.cloudfront.net/Socialmediaprofile',
    CALLBACK_SUCCESS_REDIRECT_URL_LOCAL : 'https://localhost:4200/Socialmediaprofile?authorized=',
    CALLBACK_SUCCESS_REDIRECT_URL_AWS : 'https://d3rtuj6gjvv7z0.cloudfront.net/Socialmediaprofile?authorized=',
}